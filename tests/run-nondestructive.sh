...
PASSWD_FILE="$ROOT/tests/fixtures/passwd-clean" "$ROOT/linux/U-52.sh" >/dev/null
grep -q '"status": "PASS"' "$ROOT/linux/KISA_RESULT/U-52.json"

PASSWD_FILE="$ROOT/tests/fixtures/passwd-duplicate" "$ROOT/linux/U-52.sh" >/dev/null
...
PASSWD_FILE="$tmpdir/passwd-clean" "$ROOT/linux/U-57.sh" >/dev/null
grep -q '"status": "PASS"' "$ROOT/linux/KISA_RESULT/U-57.json"

PASSWD_FILE="$tmpdir/passwd-bad" "$ROOT/linux/U-57.sh" >/dev/null
